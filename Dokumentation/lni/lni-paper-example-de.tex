...
% \subsection{Sicherheitsframeworks}

% \subsubsection{MonaLisa}
...
wie HTTPS wurde in dem Anwendungsbeispiel aufgegriffen und liefert ebenfalls eine gute Alternative zu einer 
